...
export default function Header() {
  ...
  const NavContent = (
    <>
      <nav className={`flex ${sideNav && "flex flex-col"} font-semibold items-center gap-10 cursor-pointer`}>
        <p className="hover:text-green-950 hover:font-bold">Category</p>
      ...
      <button className="font-bold flex items-center gap-2 mt-2">
  ...
  return (
    <>
      ...
      {sideNav && (
        <div className="fixed top-0 right-0 w-3/4 h-full bg-white shadow-lg z-50 p-5 lg:hidden">
